/**
 * The grammal for Go language is defined (and optimized for our purposes) referencing the
 * official Go documentation, which can be found at: https://golang.org/ref/spec
 * Token, symbol and rule names were also taken from that document, for better understandability.
 */
grammar Go;
...
// All kinds of letters that are supported in Golang sources.
fragment LETTER
    : UNICODE_LETTER
    | '_'
    ;
...
// Those are taken from https://www.unicode.org/Public/UCD/latest/ucd/
