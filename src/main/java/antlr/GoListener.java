...
public interface GoListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link GoParser#topLevelDecl}.
	 * @param ctx the parse tree
	 */
	void enterTopLevelDecl(GoParser.TopLevelDeclContext ctx);
	/**
	 * Exit a parse tree produced by {@link GoParser#topLevelDecl}.
	 * @param ctx the parse tree
	 */
	void exitTopLevelDecl(GoParser.TopLevelDeclContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GoParser#selector}.
	 * @param ctx the parse tree
	 */
	void enterSelector(GoParser.SelectorContext ctx);
	/**
	 * Exit a parse tree produced by {@link GoParser#selector}.
	 * @param ctx the parse tree
	 */
	void exitSelector(GoParser.SelectorContext ctx);
	/**
