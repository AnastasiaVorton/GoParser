...
public interface GoVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link GoParser#topLevelDecl}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTopLevelDecl(GoParser.TopLevelDeclContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GoParser#function}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFunction(GoParser.FunctionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GoParser#parameterList}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParameterList(GoParser.ParameterListContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link GoParser#selector}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitSelector(GoParser.SelectorContext ctx);
	/**
